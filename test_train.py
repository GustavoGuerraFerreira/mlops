...
def sample_data():
    ...
    Returns:
    pandas.DataFrame: A DataFrame containing sample data with three columns:
    'feature1',
...
def test_read_data():
    """
    This function tests the `read_data` function. It checks whether the returned
    data is not
...
def test_create_model():
    """
    Generate the function comment for the given function body in a markdown code
    block with
